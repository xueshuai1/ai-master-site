---
title: "深度可分离卷积（Depthwise Separable Convolution）"
category: "CNN 基础"
difficulty: "⭐⭐"
...
> **分类**: CNN 基础（计算机视觉） | **编号**: CV-10 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`CNN` `卷积神经网络` `深度学习` `计算机视觉`

**摘要**: 深度可分离卷积（Depthwise Separable Convolution）是一种高效的卷积变体，将标准卷积分解为两个独立的步骤：深度卷积（Depthwise Convolution）和逐点...
