...
**摘要**: 分类: 优化算法 | 编号: 049 | 更新时间: 2026-04-01 | 难度: ⭐⭐Adam 优化算法 自适应学习率 动量--- 1. 概述AdamW 是 Adam 的改进版本，正确实现权重衰减，在深度学习中表现优于 Adam。核心思想： "解耦权重衰减"——权重衰减不与自适应学习率耦合。 ...


> **分类**: 优化算法 | **编号**: 049 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
