...
category: "集成学习"
difficulty: "⭐⭐"
tags: ['Bagging', '集成学习', '自助采样', '随机森林']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 集成学习 | 编号: 011 | 更新时间: 2026-04-01 | 难度: ⭐⭐Bagging 集成学习 自助采样 随机森林--- 1. 概述Bagging（Bootstrap Aggregating，自助聚合）是一种集成学习技术，通过对训练数据进行有放回抽样，训练多个基学习器，然后聚合...


> **分类**: 集成学习 | **编号**: 011 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`Bagging` `集成学习` `自助采样` `随机森林`
