...
category: "优化算法"
difficulty: "⭐⭐"
tags: ['Adam', '优化算法', '自适应学习率', '动量']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 优化算法 | 编号: 048 | 更新时间: 2026-04-01 | 难度: ⭐⭐Adam 优化算法 自适应学习率 动量--- 1. 概述Adam（Adaptive Moment Estimation）是自适应学习率优化算法，结合动量和 RMSProp，是深度学习最常用的优化器。核心思想：...


> **分类**: 优化算法 | **编号**: 048 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
