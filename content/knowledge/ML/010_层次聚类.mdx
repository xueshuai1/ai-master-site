...
category: "聚类算法"
difficulty: "⭐⭐"
tags: ['层次聚类', '聚类', '无监督学习', '树状图']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 聚类算法 | 编号: 010 | 更新时间: 2026-04-01 | 难度: ⭐⭐层次聚类 聚类 无监督学习 树状图--- 1. 概述层次聚类是一种构建簇层次结构的聚类方法，可以生成树状结构（树形图/dendrogram）。与 K-Means 不同，层次聚类不需要预先指定簇数量，可以通过切...


> **分类**: 聚类算法 | **编号**: 010 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
