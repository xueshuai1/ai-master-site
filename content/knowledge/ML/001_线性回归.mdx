...
category: "回归算法"
difficulty: "⭐⭐"
tags: ['线性回归', '回归', '监督学习', 'MSE', '梯度下降']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 回归算法 | 编号: 001 | 更新时间: 2026-04-01 | 难度: ⭐⭐线性回归 回归 监督学习 MSE 梯度下降--- 1. 概述线性回归是机器学习中最基础、最经典的监督学习算法之一，用于预测连续型目标变量。它通过建立自变量（特征）与因变量（目标）之间的线性关系模型，实现对未知...


> **分类**: 回归算法 | **编号**: 001 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`线性回归` `回归` `监督学习` `MSE` `梯度下降`
