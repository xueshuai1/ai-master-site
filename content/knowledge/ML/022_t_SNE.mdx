...
**摘要**: 分类: 机器学习 | 编号: 022 | 更新时间: 2026-04-01 | 难度: ⭐⭐机器学习 ML 面试--- 1. 概述t-SNE（t-Distributed Stochastic Neighbor Embedding）是一种非线性降维算法，特别适合高维数据的可视化。t-SNE 通过保持局...


> **分类**: 机器学习 | **编号**: 022 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
