...
**摘要**: 分类: 集成学习 | 编号: 016 | 更新时间: 2026-04-01 | 难度: ⭐⭐Boosting 集成学习 迭代 加权--- 1. 概述Gradient Boosting（梯度提升，GBDT）是一种强大的集成学习算法，通过迭代训练弱学习器来拟合前一轮的残差（负梯度），逐步提升模型性能。与...


> **分类**: 集成学习 | **编号**: 016 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
