...
**摘要**: 分类: 评估指标 | 编号: 040 | 更新时间: 2026-04-01 | 难度: ⭐⭐机器学习 ML 面试--- 1. 概述ROC（Receiver Operating Characteristic）曲线和 AUC（Area Under Curve）是二分类模型评估的重要指标，衡量模型区分正负...


> **分类**: 评估指标 | **编号**: 040 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
