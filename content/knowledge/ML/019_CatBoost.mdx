---
title: "CatBoost 类别特征提升"
category: "集成学习"
difficulty: "⭐⭐"
tags: ['CatBoost', '梯度提升', '集成学习', '类别特征']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 集成学习 | 编号: 019 | 更新时间: 2026-04-01 | 难度: ⭐⭐CatBoost 梯度提升 集成学习 类别特征--- 1. 概述CatBoost（Categorical Boosting）是 Yandex 于 2017 年开源的梯度提升算法，专为高效处理类别特征而设计。C...


> **分类**: 集成学习 | **编号**: 019 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`CatBoost` `梯度提升` `集成学习` `类别特征`
