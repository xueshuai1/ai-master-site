...
category: "集成学习"
difficulty: "⭐⭐"
tags: ['AdaBoost', 'Boosting', '集成学习', '自适应']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 集成学习 | 编号: 015 | 更新时间: 2026-04-01 | 难度: ⭐⭐AdaBoost Boosting 集成学习 自适应--- 1. 概述AdaBoost（Adaptive Boosting，自适应提升）是 Boosting 家族中最经典的算法，由 Freund 和 Scha...


> **分类**: 集成学习 | **编号**: 015 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`AdaBoost` `Boosting` `集成学习` `自适应`
