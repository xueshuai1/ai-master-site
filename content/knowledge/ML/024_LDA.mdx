...
category: "降维算法"
difficulty: "⭐⭐"
tags: ['LDA', '降维', '判别分析', '监督学习']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 降维算法 | 编号: 024 | 更新时间: 2026-04-01 | 难度: ⭐⭐LDA 降维 判别分析 监督学习--- 1. 概述LDA（Linear Discriminant Analysis，线性判别分析）是一种监督降维算法，通过最大化类间方差与类内方差的比值，找到最佳投影方向。核心...


> **分类**: 降维算法 | **编号**: 024 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
