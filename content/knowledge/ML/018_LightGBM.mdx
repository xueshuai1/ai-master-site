---
title: "LightGBM 轻量级梯度提升"
category: "集成学习"
difficulty: "⭐⭐"
tags: ['LightGBM', '梯度提升', '集成学习', '直方图']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 集成学习 | 编号: 018 | 更新时间: 2026-04-01 | 难度: ⭐⭐LightGBM 梯度提升 集成学习 直方图--- 1. 概述LightGBM（Light Gradient Boosting Machine）是微软于 2017 年开源的高效梯度提升框架。相比 XGBoos...


> **分类**: 集成学习 | **编号**: 018 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`LightGBM` `梯度提升` `集成学习` `直方图`
