...
**摘要**: 分类: 机器学习 | 编号: 008 | 更新时间: 2026-04-01 | 难度: ⭐⭐机器学习 ML 面试--- 1. 概述K-Means 是一种经典的无监督学习算法，用于将数据划分为 K 个簇（clusters）。它通过迭代优化簇中心，使得簇内样本距离最近，簇间样本距离最远。核心思想： 物以...


> **分类**: 机器学习 | **编号**: 008 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
