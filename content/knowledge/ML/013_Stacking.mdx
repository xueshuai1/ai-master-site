...
category: "集成学习"
difficulty: "⭐⭐"
tags: ['Stacking', '集成学习', '元学习器', '模型融合']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 集成学习 | 编号: 013 | 更新时间: 2026-04-01 | 难度: ⭐⭐Stacking 集成学习 元学习器 模型融合--- 1. 概述Stacking（Stacked Generalization，堆叠泛化）是一种多层集成学习技术，通过将多个基学习器的预测结果作为输入，训练一个...


> **分类**: 集成学习 | **编号**: 013 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`Stacking` `集成学习` `元学习器` `模型融合`
