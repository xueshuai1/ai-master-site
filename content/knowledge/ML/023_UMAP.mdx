...
category: "降维算法"
difficulty: "⭐⭐"
tags: ['UMAP', '降维', '可视化', '流形学习']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 降维算法 | 编号: 023 | 更新时间: 2026-04-01 | 难度: ⭐⭐UMAP 降维 可视化 流形学习--- 1. 概述UMAP（Uniform Manifold Approximation and Projection）是一种现代非线性降维算法，基于流形学习和拓扑理论。相比 ...


> **分类**: 降维算法 | **编号**: 023 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
