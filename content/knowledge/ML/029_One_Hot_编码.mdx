...
**摘要**: 分类: 特征工程 | 编号: 029 | 更新时间: 2026-04-01 | 难度: ⭐⭐机器学习 ML 面试--- 1. 概述One-Hot 编码是将类别特征转换为二进制向量的编码方法，每个类别对应一个独立的二进制特征。核心思想： "一个类别一个特征"——将类别转换为数值。 1.1 编码示例原始...


> **分类**: 特征工程 | **编号**: 029 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
