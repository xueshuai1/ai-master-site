...
category: "集成学习"
difficulty: "⭐⭐"
tags: ['XGBoost', '梯度提升', '集成学习', '正则化']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 集成学习 | 编号: 017 | 更新时间: 2026-04-01 | 难度: ⭐⭐XGBoost 梯度提升 集成学习 正则化--- 1. 概述XGBoost（eXtreme Gradient Boosting）是 Gradient Boosting 的高效改进版本，由陈天奇于 2016 年...


> **分类**: 集成学习 | **编号**: 017 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`XGBoost` `梯度提升` `集成学习` `正则化`
