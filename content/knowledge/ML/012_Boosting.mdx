...
**摘要**: 分类: 集成学习 | 编号: 012 | 更新时间: 2026-04-01 | 难度: ⭐⭐Boosting 集成学习 迭代 加权--- 1. 概述Boosting 是一种集成学习技术，通过顺序训练多个弱学习器，每个新学习器关注前一个学习器的错误，最终将弱学习器组合成强学习器。与 Bagging 的...


> **分类**: 集成学习 | **编号**: 012 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
