...
category: "机器学习"
difficulty: "⭐⭐"
tags: ['决策树', '分类', '回归', '信息增益', 'CART']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 机器学习 | 编号: 003 | 更新时间: 2026-04-01 | 难度: ⭐⭐决策树 分类 回归 信息增益 CART--- 1. 概述决策树是一种监督学习算法，可用于分类和回归任务。它通过一系列 if-then 规则对数据进行划分，形成树状结构。决策树直观易懂，是集成学习（如随机森林、...


> **分类**: 机器学习 | **编号**: 003 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
