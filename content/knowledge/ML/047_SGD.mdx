...
category: "优化算法"
difficulty: "⭐⭐"
tags: ['SGD', '随机梯度下降', '优化算法', 'mini-batch']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 优化算法 | 编号: 047 | 更新时间: 2026-04-01 | 难度: ⭐⭐SGD 随机梯度下降 优化算法 mini-batch--- 1. 概述SGD（Stochastic Gradient Descent，随机梯度下降）是梯度下降的变体，每次用一个样本更新参数，适合大规模数据。核...


> **分类**: 优化算法 | **编号**: 047 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`SGD` `随机梯度下降` `优化算法` `mini-batch`
