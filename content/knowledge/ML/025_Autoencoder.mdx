...
category: "降维算法"
difficulty: "⭐⭐"
tags: ['Autoencoder', '自编码器', '降维', '神经网络', '无监督学习']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 降维算法 | 编号: 025 | 更新时间: 2026-04-01 | 难度: ⭐⭐Autoencoder 自编码器 降维 神经网络 无监督学习--- 1. 概述Autoencoder（自编码器）是一种神经网络降维算法，通过编码器 - 解码器结构学习数据的压缩表示。核心思想： "学习压缩"—...


> **分类**: 降维算法 | **编号**: 025 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐

`Autoencoder` `自编码器` `降维` `神经网络` `无监督学习`
