---
title: "HistGradientBoosting 直方图梯度提升"
category: "集成学习"
difficulty: "⭐⭐"
tags: ['Boosting', '集成学习', '迭代', '加权']
createdAt: "2026-04-01"
updatedAt: "2026-04-01"
---

**摘要**: 分类: 集成学习 | 编号: 020 | 更新时间: 2026-04-01 | 难度: ⭐⭐Boosting 集成学习 迭代 加权--- 1. 概述HistGradientBoosting 是 scikit-learn 0.21+ 引入的基于直方图的梯度提升算法，灵感来自 LightGBM。它将连续...


> **分类**: 集成学习 | **编号**: 020 | **更新时间**: 2026-04-01 | **难度**: ⭐⭐
