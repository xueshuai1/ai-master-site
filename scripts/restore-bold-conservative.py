#!/usr/bin/env python3
"""
FINAL restore of bold - very conservative.
Only bold:
1. Short labels (≤ 6 chars) at paragraph starts followed by ： or :
   e.g., "要素一：", "来源：", "概念："
2. ALWAYS_BOLD terms (OpenAI, Claude, etc.)

This should give ~3-8 bold per file average.
"""
...
def add_bold(text):
    ...
    for line in lines:
        ...
        if not stripped:
            result.append(line)
            continue
        # Short label (≤ 6 chars) at start followed by ： or :
