...
def check_laws_compliance(system_design: dict) -> list[str]:
    ...
    D1 -.->|不可逆扩散| E`,
        ...
        {
            title: "2. 自主武器的国际法争议",
            body: `致命性自主武器系统（Lethal Autonomous Weapons Systems, L**AWS**） 是军事 AI 伦理争议的核心焦点。L**AWS** 被定义为能够在无需人类干预的情况下选择并攻击目标的武器系统。这一概念自 2013 年首次在联合国 CCW（特定常规武器公约） 框架下被讨论以来，已经成为国际人道法领域最激烈的辩论话题之一。
...
- 预防原则（Precaution）：冲突方必须采取一切可行措施避免或最小化平民伤害。L**AWS** 的自主决策速度（毫秒级）是否给人类留下了足够的干预时间？

### 联合国 CCW 框架下的进展

联合国 CCW 框架下关于 L**AWS** 的讨论已经持续超过 10 年，但进展极为缓慢：

- 2014-2018：召开多次政府专家组会议，达成「人类控制应保留」的共识声明，但无法律约束力
- 2019-2021：部分国家（奥地利、巴西）提出具有法律约束力的禁令草案，但被军事大国否决
- 2023：通过新的指导原则框架，要求 L**AWS** 必须保留有意义的人类控制（Meaningful Human Control, MHC）
...
- 支持严格监管/禁止：奥地利、巴西、巴基斯坦、梵蒂冈等 30+ 国家支持具有法律约束力的 L**AWS** 禁令
...
- CCW 框架：联合国《特定常规武器公约》框架下关于 L**AWS** 的讨论虽然进展缓慢，但已经确立了「有意义的人类控制（MHC）」的核心原则。2023 年通过的指导原则要求，L**AWS** 的设计和使用必须确保人类能够理解、干预和终止系统的自主行动
...
随着军事 AI 的技术成熟度和部署规模持续提升，国际社会关于 L**AWS** 的讨论将逐渐从「是否应该禁止」转向「如何有效监管」。这一转变的驱动力在于：

- 技术不可逆性：军事 AI 技术已经在多个国家实现实战部署，完全禁止在政治上不可行
- 实用主义共识：即使在主张禁止 L**AWS** 的国家内部，也越来越多人认识到非致命性军事 AI的合法性和必要性
...
- 联合国 CCW 《L**AWS** 政府专家组报告》（2023）——各国政府关于 L**AWS** 监管的正式立场汇总
...
- L**AWS** Compliance Checker：开源工具，用于评估 AI 军事系统是否符合国际人道法的核心原则
