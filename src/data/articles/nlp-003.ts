...
class BiLSTMAttention(nn.Module):
    ...
    G --> H["Softmax 分类"]`,
        ...
        },
        {
            ...
            body: `BERT（Bidirectional Encoder Representations from **Transformer**s, 2018）的出现彻底改变了文本分类的范式。通过在大规模无标注语料上进行自监督预训练，BERT 学到了深层的语言理解能力，只需少量标注数据微调即可在各类分类任务上取得 State-of-the-Art 效果。
