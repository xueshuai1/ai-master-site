...
生成式 AI是 2026 年最热门的合成数据生成方式。利用大语言模型（**GPT-4**o、**Claude**）生成文本数据，利用扩散模型（Stable Diffusion、DALL-E）生成图像数据，利用语音生成模型（VALL-E）生成音频数据。生成式 AI 的优势在于可以快速生成大量多样化的数据，并且通过精心设计的 Prompt 可以精确控制生成数据的特征分布。
