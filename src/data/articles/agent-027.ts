...
Andreas 并不是说 Agent 的界面不能友好。问题在于 Agent 的内部行为模式——当 Agent 像人类一样犹豫、解释过多、回避困难任务时，它作为工具的价值就大幅降低了。
...
设计机器执行系统"]
    ...
    class B1 s1
    class C s0
    classDef s0 fill:#991b1b,stroke:#b91c1c,color:#fff
    classDef s1 fill:#92400e,stroke:#b45309,color:#fff
    classDef s2 fill:#92400e,stroke:#b45309,color:#fff
    classDef s3 fill:#991b1b,stroke:#b91c1c,color:#fff
    classDef s4 fill:#991b1b,stroke:#b91c1c,color:#fff`,
    },
    {
...
Auto Retry"]
    ...
    class C s1
    class B s0
    classDef s0 fill:#047857,stroke:#047857,color:#fff
    classDef s1 fill:#4338ca,stroke:#4338ca,color:#fff
    classDef s2 fill:#991b1b,stroke:#b91c1c,color:#fff
...
最实用的方案是混合模式——同一个 Agent 系统根据任务类型自动切换行为模式：（见下方代码：AdaptiveAgent 自适应路由）
...
先执行后说明"]
    ...
    classDef s2 fill:#92400e,stroke:#b45309,color:#fff
    classDef s3 fill:#6d28d9,stroke:#6d28d9,color:#fff`,
    },
    {
