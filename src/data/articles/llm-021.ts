...
FP8 方案在成本（节省 50%）和精度（损失 <1%）之间取得了最佳平衡。`,
    ...
    section 准备阶段
    模型 FP8 量化校准     :2026-04-01, 3d
    精度验证测试           :2026-04-04, 2d
    section 部署阶段
    Docker 环境搭建        :2026-04-06, 2d
    服务配置与调优         :2026-04-08, 3d
    压测与基准对比         :2026-04-11, 2d
    section 上线阶段
    灰度发布 (10%)         :2026-04-13, 3d
    灰度发布 (50%)         :2026-04-16, 3d
    全量发布              :2026-04-19, 1d
    section 运维阶段
    精度监控与告警配置     :2026-04-20, 2d
    持续优化与调优         :2026-04-22, 14d`,
    },
    {
