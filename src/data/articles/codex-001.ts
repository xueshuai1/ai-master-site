...
人类监督"]
    ...
    classDef s2 fill:#5b21b6,stroke:#7c3aed,color:#f1f5f9`,
    },
    {
...
这种架构让 Codex 不仅能写代码，还能操作任何有界面的应用——浏览器、IDE、文件管理器、甚至 Photoshop。`,
    ...
    class C s0
    classDef s0 fill:#1d4ed8,stroke:#1d4ed8,color:#fff
    classDef s1 fill:#5b21b6,stroke:#7c3aed,color:#f1f5f9
...
# print(result["report"])`,
    ...
    },
    {
      ...
      body: `Codex 的自主执行能力虽然强大，但也带来了前所未有的安全挑战。当一个 AI 可以自主操作你的计算机时，信任与安全的边界变得极其关键。
...
**OpenAI** 在 Codex 中实现了多层安全防护，确保自主执行的能力不会成为安全隐患。`,
    ...
    classDef s1 fill:#b91c1c,stroke:#dc2626,color:#fff
    classDef s2 fill:#047857,stroke:#059669,color:#fff
    classDef s3 fill:#047857,stroke:#059669,color:#fff
    classDef s4 fill:#92400e,stroke:#d97706,color:#fff`,
    },
    {
