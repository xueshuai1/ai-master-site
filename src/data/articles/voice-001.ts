...
export const article: Article = {
  ...
  content: [
    {
      title: "语音 AI 技术全景",
      body: `2026 年被认为是「语音 AI 元年」。从 **NVIDIA** 开源 PersonaPlex 全双工语音模型，到 **Google DeepMind** 发布 Audio Flamingo Next 最强开源音频语言模型，再到 Moshi**RAG** 实现全双工语音+实时知识检索——语音 AI 正在从「文本转语音」的附属能力，升级为独立的交互范式。
...
Moshi**RAG**：全双工 + 知识检索（2026 最新）

2026 年 4 月发布的 Moshi**RAG** 解决了全双工语音模型的一个关键问题：如何在不打断对话流畅性的同时获取外部知识？
...
**5. 知识检索**：如何在实时对话中获取外部信息（Moshi**RAG** 的突破）`,
    },
    {
...
| Moshi**RAG** | 全双工+检索 | 异步检索架构，无需重新训练 |
...
**5. 知识检索**：Moshi**RAG** 迈出第一步，但还有优化空间
