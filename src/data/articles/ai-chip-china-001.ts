...
output = quantized_model(input_tensor)  # INT8 推理`,
        ...
        },
        {
            ...
            body: `摩尔线程和沐曦集成电路是中国GPU 赛道的两大主力，都试图在**NVIDIA** 的 CUDA 生态壁垒中找到突破口。
...
燧原科技专注于云端 AI 训练和推理，其 邃思（DTU） 系列芯片采用自研架构，在大模型训练场景中具有一定竞争力。燧原的软件栈 驭算（TopsRider） 支持 PyTorch 和 TensorFlow，并且针对**Transformer** 架构做了专项优化。燧原与腾讯云有深度合作，在腾讯的 AI 业务线中有实际应用。
