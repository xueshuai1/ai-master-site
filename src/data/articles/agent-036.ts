...
LangChain 的最大优势是生态——社区活跃、教程丰富、插件众多。但**它的最大问题是链式架构的僵化性**——一旦定义了检索链，修改流程需要重构整个链，缺乏原子组件化架构的灵活性。
...
- 「GraphRAG: A Graph-Augmented Retrieval System」(Edge et al., 2024) — 图谱增强检索，知识 Agent 多源知识关联的技术框架
