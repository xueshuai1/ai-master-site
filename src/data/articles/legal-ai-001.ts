...
第二，大语言模型的推理能力跨越了法律应用的门槛。2025 年底，**GPT-4o** 和 **Claude** 3.5 在法律推理基准（如 LexGLUE、ContractNLI）上的表现首次超过人类律师平均水平。这不再是\"AI 能写一些法律文本\"的问题，而是\"AI 能正确理解法律逻辑并做出判断\"的问题。
...
法律指令数据集的构建方法：
****- 专家标注****：由资深律师编写和审核指令数据
****- 合成数据****：利用强模型（如 **GPT-4**o）生成初始指令数据，再由人类律师审核
