    ...
    },
{
    ...
    },
  {
      ...
      category: "multimodal",
      description: `Voicebox 是开源的语音合成工作室，提供高质量的文本转语音 (TTS) 能力。支持多语言、多音色、情感化语音生成，20,784 stars。与商业 TTS 服务不同，Voicebox 完全开源可自部署，提供 Web UI 和 API 两种使用方式。支持声音克隆（少量样本即可）、实时流式输出、SSML 标记语言控制韵律和语调，是播客制作、有声书生成、游戏配音和 AI 语音助手的理想选择`,
