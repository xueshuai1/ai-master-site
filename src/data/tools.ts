...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    category: "framework",
    description: "字节跳动开源的高精度生物分子结构预测工具，面向蛋白质折叠等科学计算场景，是 AI for Science 方向对标 AlphaFold 的开源实现。GitHub 1.8k stars",
  ...
  },
  {
    ...
    name: "DFlash (z-lab)",
    category: "framework",
    description: "Block Diffusion for Flash Speculative Decoding，加速 LLM 推理的新型解码方法。通过推测解码 + 块扩散显著降低 LLM 推理延迟。GitHub 1.3k stars",
