...
export const blogs: BlogPost[] = [
  {
    id: "blog-023",
    title: "LLM 的"有害基因"：大模型生成有害内容的统一内在机制被发现",
    summary:
      "arXiv 2026 年 4 月的重磅论文发现：LLM 生成有害内容依赖于一个紧凑的、跨有害类型通用的权重子集。对齐训练会压缩这些权重，而这恰好解释了微调攻击导致"涌现式不对齐"的根本原因。剪枝这些权重可以大幅降低模型有害性而不影响正常能力——这可能是 AI 安全领域最重要的机制可解释性发现之一。",
    content: `
