...
- 英文原生模型（GPT-4o、Claude）的中文税最为严重，中文 Token 消耗是英文的 1.65-1.75 倍
...
假设一个中型中文 AI 应用的月度使用情况：月均 50M tokens 的英文等效量，60% 中文使用比例，按 $5/M token 定价（GPT-4o 级别）。
...
OpenAI（GPT-4o / GPT-4.5） 使用的是 cl100k_base Tokenizer：词表大小 100,256 个 Token，英文覆盖率极高（99.9% 的英文词汇在词表中），中文覆盖率较低（大量中文常用组合不在词表中），中文回退策略使用字节级 BPE，每个中文字符约 1.5-3 个 Token。
