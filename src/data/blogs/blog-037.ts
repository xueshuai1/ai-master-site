...
当前最热门的创新集中在 TTS 和 Voice Cloning 这两个输出环节。Voicebox、VoxCPM2 等项目的突破主要在这里。`,
    ...
    style F fill:#ff6b35,color:#1e293b
    style H fill:#4ecdc4,color:#1e293b`,
  },
  {
...
VoxCPM2 的核心技术是一个自回归 Transformer，直接预测连续的声学特征序列。与传统方案相比，它的主要优势在于端到端的简洁性和多语言的原生支持。`,
    ...
    style B1 fill:#4ecdc4,color:#1e293b
    style B3 fill:#ff6b35,color:#1e293b
    style A2 fill:#ff6b6b,color:#1e293b`,
    code: [
      {
        lang: "python",
...
Omi 的增长（11,626 星，+3,634/周）反映了开发者对这一方向的兴趣。它与 Voicebox、VoxCPM2 一起，构成了 Voice AI 的完整生态：从声音合成到语音交互。`,
    ...
    style C fill:#ff6b35,color:#1e293b
    style F fill:#4ecdc4,color:#1e293b
    style J fill:#45b7d1,color:#1e293b`,
  },
  {
...
Voice AI 不是孤立的技术赛道，它与 LLM、Agent、多模态等技术深度融合。当 Agent 能"听"到你在说什么、"看"到你在做什么、并且用自然的声音回复你时，AI 才真正成为人类的伙伴。`,
    ...
    style C fill:#ff6b35,color:#1e293b
    style K fill:#4ecdc4,color:#1e293b
    style A fill:#45b7d1,color:#1e293b
    style E fill:#45b7d1,color:#1e293b`,
    tip: `**进一步学习：**
