...
const content: ArticleSection[] = [
  ...
  {
    title: "对比 Meta 的做法",
    body: "有趣的是，**就在 Anthropic 宣布延迟 Mythos 的第二天，Meta 发布了其 Superintelligence Lab 的第一个 AI 模型——Muse Spark**（内部代号 Avocado）。",
    table: {
