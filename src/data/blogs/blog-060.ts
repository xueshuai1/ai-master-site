...
关键洞察： autoresearch 不是替代 AutoML，而是将其扩展到了代码级自主探索——Agent 不只是调超参数，而是可以修改模型架构、训练策略、甚至发明新的优化方法。`
    },
    {
...
program.md 不是传统的实验计划书，而是一种人机协作协议。它需要同时满足：
...
关键洞察： nanochat 不是要取代主流框架，而是为AI 自主科研场景量身定制——在这个场景下，"Agent 能理解并安全修改代码"比"功能丰富"更重要。`
    },
    {
...
1. autoresearch 的本质：不是自动化实验工具，而是AI 与人类研究者的协作协议
