...
致命性自主武器系统（Lethal Autonomous Weapons Systems, L**AWS**） 是指能够在没有人类干预的情况下选择并攻击目标的武器系统。
...
目前的国际法律框架对 L**AWS** 的规制严重不足：

- 《特定常规武器公约》（CCW）：联合国框架下讨论 L**AWS** 的主要平台，但进展缓慢——各国对「有意义的人类控制」的定义存在根本分歧
- 《禁止核武器条约》模式：一些国家呼吁参照禁止核武器的模式制定禁止 L**AWS** 的条约，但主要军事大国（美、中、俄）均反对
****- 各国立场****：
  ****- 美国****：支持「负责任地使用」自主武器，反对全面禁止
  ****- 中国****：支持限制 L**AWS** 的使用范围，但保留研发权利
  ****- 欧盟****：呼吁制定具有法律约束力的国际协议
  **- 30+ 国家**：呼吁全面禁止 L**AWS**
...
尽管全面禁止 L**AWS** 的协议短期内难以达成，但限制自主武器使用范围的区域性协议或行为准则可能在 2028-2030 年出现。
