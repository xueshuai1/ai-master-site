...
Multi-Agent 不是简单的「多调用几次 LLM」，而是通过**系统化的角色设计、通信协议和协调机制**，构建出超越单一模型能力的复合智能系统。`,
    ...
    style B fill:#ff6b35,color:#1e293b
...
| 回滚能力 | 困难 | 简单（删除技能）`,
    ...
    style E fill:#ff6b35,color:#1e293b
    style G fill:#4ecdc4,color:#1e293b
    style J fill:#134e4a`,
  },
  {
...
- 建立 Agent 行为基线，异常时自动告警`,
    ...
    style A fill:#ff6b35,color:#1e293b
    style M fill:#4ecdc4,color:#1e293b
    style Q fill:#134e4a`,
  },
  {
...
- 🎯 实践：用上面的 Python 代码搭建你的 Multi-Agent 金融分析系统`,
    ...
    style E fill:#ff6b35,color:#1e293b
    style J fill:#4ecdc4,color:#1e293b`,
  },
];
