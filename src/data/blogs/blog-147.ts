...
**OpenAI** 此前在算力方面拥有**Microsoft** 的强大支持——**Microsoft** 的 **Azure** 云为 **OpenAI** 提供了庞大且稳定的 GPU 供应。然而，随着 **Anthropic** 通过 Colossus 获得同等量级的算力，**OpenAI** 的算力优势正在缩小。
...
无论 AI 公司之间如何竞争和联盟，GPU 的供应商 **NVIDIA**都是最大的赢家。**Anthropic**-**xAI** 合作意味着GPU 需求进一步增长——**Anthropic** 增加了算力采购，**xAI** 通过出租算力获得了收入，这两者都会推动 **NVIDIA** GPU 的销量和价格。
...
****核心逻辑****：通过**AWS**、Google Cloud、**Azure**等云服务商按需购买算力，无需自建基础设施。
