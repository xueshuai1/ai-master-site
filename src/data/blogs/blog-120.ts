...
关键结论：**海上数据中心不适合超大规模分布式训练（需要亚微秒级通信），但完全适合推理和数据预处理场景**：
...
**2026 年是 AI 算力需求从线性增长转向指数增长的拐点**。GPT-4 之后的新一代模型需要 10 倍以上的算力，而陆地数据中心的电力和土地供给正在逼近极限。这种供需矛盾创造了对替代方案的真实需求——而非概念炒作。
...
战略上：**海上数据中心不是要替代陆地，而是要在陆地无法建设的地方建设**——它是 AI 算力版图中的「新大陆」，而非「旧大陆的取代者」。
