...
└── > 20 人 → 基于开源定制 (FAISS + 自建服务层)
    ...
    },
    {
        ...
        body: `Agent 编排平台是 AI Infra 赛道中最新兴但也最具潜力的方向。2026 年 Q2，该领域获得了1.8 亿美元的融资，资本看好 Agent 编排将成为AI 时代的操作系统。
...
Agent 编排：窗口刚打开，风险回报比最优`
    ...
    },
    {
        ...
        body: `AI Infra 创业爆发不是孤立现象，而是AI 产业进入新阶段的必然结果。本节从技术、市场、资本三个维度深度解读这轮爆发的深层原因。
