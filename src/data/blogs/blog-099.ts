...
ChatGPT Images 2.0 基于 **OpenAI** 自研的扩散模型架构，与 **GPT-4**o 共享部分视觉理解能力。这种架构的优势在于文本理解和 prompt 解析——因为 **GPT-4**o 本身就是一个强大的多模态模型，ChatGPT Images 2.0 可以直接利用 **GPT-4**o 的语义理解能力来解析复杂 prompt。
