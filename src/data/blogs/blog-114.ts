...
15 亿美元在企业 AI 服务领域的合资中属于中等偏上规模。对比参考：
...
第一：基础设施建设（约 40%，6 亿美元）。包括企业级 GPU 算力集群的搭建、全球数据中心的部署、以及安全隔离环境的建设。对于面向金融和医疗等合规行业的 AI 服务来说，专用的安全基础设施是基础投入。
...
本文第 2 章分析的「Blackstone 的关系杠杆」和「高盛的行业壁垒」在 15 亿美元的规模下得到了进一步验证——这笔资金的核心价值不在于金额本身，而在于背后的渠道杠杆效应。通过 Blackstone 和高盛的企业网络，这 15 亿美元可能撬动数百亿美元的企业 AI 服务市场。

关键观察：15 亿美元的规模说明 Anthropic 和其合作伙伴选择了稳健起步的策略——不追求一开始就全面铺开，而是先验证核心商业模式，再逐步扩大规模。这与 OpenAI 的「全面扩张」策略形成了鲜明对比。`,
        tip: `更新说明：
