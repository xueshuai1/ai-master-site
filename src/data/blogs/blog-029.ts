...
const content: ArticleSection[] = [
  ...
  },
  {
    ...
    body: `Firefly AI 助手能够在 Creative Cloud 应用中自主操作，背后依赖一套三层技术架构：感知层、决策层和执行层。\n\n第一层：感知层（Perception）\n\nAI 需要「看到」并理解当前的设计状态。这包括：`,
    list: [
...
for action in actions:
  ...
  },
  {
    ...
    body: `感知层让 AI「看懂」了设计文档，接下来是最核心的决策层——把用户的自然语言指令翻译为可执行的操作序列。\n\n这个过程分为三个阶段：`,
    list: [
  ...
  },
  {
    ...
    body: `Firefly AI 助手代表了 AI 在创意设计领域的一次范式跃迁。下面的对比展示了它与传统 AI 绘图工具的本质差异：`,
    table: {
  ...
  {
    title: "对设计师工作流的深层影响",
    body: `Firefly AI 助手的出现不仅仅是「多了一个工具」，而是重新定义了设计师的价值定位。`,
    mermaid: `graph LR
  ...
  },
  {
    ...
    body: `Firefly AI 助手不是市场上唯一的「AI 设助手」，但它是第一个深度集成到专业设计工具链中的自主操作 AI。以下是主要竞品的对比：`,
    table: {
