...
- 多模态能力：**GPT-4**o 和 Sora 的组合使 **OpenAI** 在文本+图像+视频的多模态竞争中处于领先地位
...
技术能力仍然是入场券——没有领先的模型能力，其他维度都无从谈起。但在 2026 年，技术能力的区分度正在降低——主流模型（**GPT-4**o、**Claude**、**Gemini**）在大多数任务上的表现差距已经缩小到 5-10% 以内。
