...
export const news: NewsItem[] = [
  {
    ...
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/funding.jpg",
    ...
    content: `![news-036](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/funding.jpg)
...
- 这预示着 AI 行业的"军备竞赛"将进一步升级`,
  ...
  },
  {
    ...
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/security.jpg",
    ...
    content: `![news-035](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/security.jpg)
...
- 华尔街对此做出紧急响应，财政部长和美联储主席召集银行 CEO 讨论潜在风险`,
  ...
  },
  {
    ...
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/meta-layoffs.jpg",
    ...
    content: `![news-034](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/meta-layoffs.jpg)
...
- 广告业务因 AI 优化实现了显著增长`,
  ...
  },
  {
    ...
    tag: "公司动态",
    tagColor: "bg-yellow-500/10 text-yellow-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/microsoft-ai.jpg",
    ...
    content: `![news-033](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/microsoft-ai.jpg)
...
- 微软此举意味着所有科技巨头都在追求 AI 自主可控`,
  ...
  },
  {
    ...
    tag: "政策",
    tagColor: "bg-red-500/10 text-red-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/regulation.jpg",
    ...
    content: `![news-032](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/regulation.jpg)
...
- 参议员 Bernie Sanders 和众议员 AOC 提出了 AI 数据中心暂停法案`,
  ...
  },
  {
    ...
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/mit-research.jpg",
    ...
    content: `![news-030](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/mit-research.jpg)
...
随着 AI 模型规模不断扩大，CompreSSM 等技术解决了现代 AI 开发中最大的挑战之一：在性能与成本和效率之间取得平衡。通过在学习本身减少计算开销，这种方法有望降低先进 AI 能力的获取门槛。`,
  ...
  },
  {
    ...
    tag: "Policy",
    tagColor: "bg-yellow-500/10 text-yellow-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/policy.jpg",
    title: "特朗普政府发布 AI 框架：联邦 AI 监管的风险分级方案",
    summary: "白宫发布了全面的 AI 框架，确立了联邦政策优先级，呼吁行业特定监管、要求 AI 处理个人数据时强制披露，以及纳入 AI 在国家安全应用中的条款。",
    content: `![news-031](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/policy.jpg)
...
- 美国框架代表了一种更宽松的、以市场驱动创新为中心的方法`,
  ...
  },
  {
    ...
    tag: "趋势",
    tagColor: "bg-purple-500/10 text-purple-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/nuclear-energy.jpg",
    title: "科技巨头大举投资下一代核能，AI 算力需求重塑全球能源格局",
    summary: "微软、Google、亚马逊等科技巨头正在为下一代核能项目注入巨额资金，以应对 AI 数据中心爆炸式增长的电力需求。",
    content: `![news-005](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/nuclear-energy.jpg)
...
核能项目面临严格的监管审批流程和安全标准，科技巨头的涌入虽然带来了资金和关注度，但也需要应对复杂的环境审查和地方政府的许可程序。`,
  ...
  },
  {
    ...
    tag: "监管",
    tagColor: "bg-red-500/10 text-red-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/eu-ai.jpg",
    ...
    content: `![news-013](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/eu-ai.jpg)
...
- 部分专家警告，过度的政治游说可能导致监管真空，使公众面临更大的 AI 安全风险`,
  ...
  },
  {
    ...
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/llm-benchmark.jpg",
    ...
    content: `![news-012](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/llm-benchmark.jpg)
...
- 2026 年的基准评测格局比以往更加碎片化，也更实用`,
  ...
  },
  {
    ...
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/wall-street.jpg",
    ...
    content: `![news-011](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/wall-street.jpg)
...
- 预示着未来 AI 模型的发布可能需要经过更严格的多部门审查流程`,
  ...
  },
  {
    ...
    tag: "Funding",
    tagColor: "bg-purple-500/10 text-purple-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/venture-capital.jpg",
    ...
    content: `![news-037](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/venture-capital.jpg)
...
Tech Megacaps 计划投入超过 **3000 亿美元**用于 AI 基础设施建设，这还不包括风险投资市场的资金。`,
  ...
  },
  {
    ...
    tag: "Security",
    tagColor: "bg-red-500/10 text-red-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/cyber-warning.jpg",
    ...
    content: `![news-038](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/cyber-warning.jpg)
...
- 防御专家认为，AI 驱动的安全防御同样在进步，防御方可能获益更多`,
  ...
  },
  {
    ...
    tag: "Finance",
    tagColor: "bg-blue-500/10 text-blue-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/chip.jpg",
    ...
    content: `![news-039](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/chip.jpg)
...
CoreWeave 从一家加密货币挖矿公司转型为 AI 算力提供商，现已成为 AI 基础设施领域的重要参与者。其与 Nvidia 的紧密关系使其能够获得最新 GPU 供应。`,
  ...
  },
  {
    ...
    content: `![news-040](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/mit-research.jpg)
...
- 可能影响 AI 基础设施的投资回报率计算`,
  ...
  },
  {
    ...
    tag: "Policy",
    tagColor: "bg-yellow-500/10 text-yellow-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/datacenter.jpg",
    ...
    content: `![news-041](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/datacenter.jpg)
...
AI 发展需要 massive 算力，但算力的物理基础设施（数据中心）正在与当地社区利益产生直接冲突。这场博弈将深刻影响 AI 行业的未来布局。`,
  ...
  },
  {
    ...
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/coding.jpg",
    ...
    content: `![news-042](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/coding.jpg)
...
"AI 改变了开发者选择编程语言的方式。当 AI 让某种技术的使用变得无缝时，开发者就会蜂拥而至。"——GitHub 开发者关系团队称之为"便利循环"效应。`,
  ...
  },
  {
    ...
    tag: "行业趋势",
    tagColor: "bg-purple-500/10 text-purple-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/github-copilot.jpg",
    ...
    content: `![news-043](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/github-copilot.jpg)
...
如果你担心代码隐私，可以前往 GitHub 设置页面关闭 "Allow GitHub to use Copilot interactions for AI model training" 选项。`,
  ...
  },
  {
    ...
    tag: "模型发布",
    tagColor: "bg-blue-500/10 text-blue-300",
    coverImage: "http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/models.jpg",
    ...
    content: `![news-044](http://tdewkptsq.hd-bkt.clouddn.comhttp://tdewkptsq.hd-bkt.clouddn.com/images/news/models.jpg)
