  ...
  },
{
    ...
    summary: "The Verge 调查发现社交媒体上存在大规模推广 Perplexity AI 的"剪辑"（clipping）活动——匿名账号发布看似真实的 AI 工具使用视频来推广 Perplexity。但 Perplexity 官方否认与此有关，称"不知道"剪辑公司 Vyro 的存在，后续回应又变得模糊。",
